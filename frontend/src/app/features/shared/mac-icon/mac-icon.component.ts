    ...
    >
      @switch (name()) {
        ...
        @case ('building') {
          ...
          <path d="M9 22v-4h6v4" />
          <path
            d="M8 6h.01M16 6h.01M12 6h.01M8 10h.01M12 10h.01M16 10h.01M8 14h.01M12 14h.01M16 14h.01"
          />
        }
        @case ('home') {
        ...
        @case ('wrench') {
          <path
            d="M14.7 6.3a4 4 0 0 0-5.65 5.65L3 18l3 3 6.05-6.05a4 4 0 0 0 5.65-5.65l-2.4 2.4-2.83-2.83 2.4-2.4Z"
          />
        }
        @case ('calendar') {
        ...
        @case ('sun') {
          ...
          <path
            d="M12 2v2M12 20v2M5 5l1.4 1.4M17.6 17.6l1.4 1.4M2 12h2M20 12h2M5 19l1.4-1.4M17.6 6.4l1.4-1.4"
          />
        }
        @case ('moon') {
