...
export const routes: Routes = [
  ...
  },
  {
    path: 'reset-password',
    loadComponent: () =>
      import('./features/pages/reset-password/reset-password.page').then(
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/pages/tenants/tenants.page').then((m) => m.TenantsPage),
      },
      {
        path: 'users',
        canActivate: [roleGuard],
      ...
      },
      {
        ...
        data: { roles: ['superadmin', 'admin'] },
        loadComponent: () =>
          import('./features/pages/residents/residents.page').then((m) => m.ResidentsPage),
      },
      {
        path: 'charges',
        canActivate: [roleGuard],
        data: { roles: ['superadmin', 'admin'] },
        loadComponent: () =>
          import('./features/pages/charges/charges.page').then((m) => m.ChargesPage),
      },
      {
        path: 'payments',
        canActivate: [roleGuard],
        ...
        loadComponent: () =>
          import('./features/pages/payments/payments.page').then((m) => m.PaymentsPage),
      },
      {
        path: 'pagos/exito',
        canActivate: [roleGuard],
      ...
      },
      {
        ...
        data: { roles: ['superadmin', 'admin', 'residente', 'familiar'] },
        loadComponent: () =>
          import('./features/pages/notices/notices.page').then((m) => m.NoticesPage),
      },
